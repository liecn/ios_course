...
import Foundation
public struct HistoryChart: Codable {
...
public struct Chart: Codable {
    ...
    public init(result: [ChartResult?]?, error: ErrorCode?) {
        self.result = result
        self.error = error
    }
}
...
public struct Indicators: Codable {
    public let quote: [HistoryChartQuote?]?
    public let adjclose: [AdjClosePrice?]?
    ...
    public init(quote: [HistoryChartQuote?]?, adjclose: [AdjClosePrice?]?) {
        self.quote = quote
...
// MARK: - AdjClosePrice
public struct AdjClosePrice: Codable {
    public let adjClosePrice: [Double?]?
    
    enum CodingKeys: String, CodingKey {
        case adjClosePrice = "adjcloseprice"
    }
    
    public init(adjcloseprice: [Double?]?) {
        self.adjClosePrice = adjcloseprice
    }
}

// MARK: - ChartQuote
public struct HistoryChartQuote: Codable {
