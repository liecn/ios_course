...
public struct OptionChain: Codable {
    public let result: [StatisticsResults]?
    ...
    public init(result: [StatisticsResults]?, error: ErrorCode?) {
        self.result = result
        self.error = error
    }
}

// MARK: - StatisticResults
public struct StatisticsResults: Codable {
    public let underlyingSymbol: String?
    public let expirationDates: [Int]?
    public let strikes: [Double]?
    public let hasMiniOptions: Bool?
    public let quote: StatisticsQuote?
    ...
    public init(underlyingSymbol: String?, expirationDates: [Int]?, strikes: [Double]?, hasMiniOptions: Bool?, quote: StatisticsQuote?, options: [Option]?) {
...
// MARK: - Quote
public struct StatisticsQuote: Codable {
...
public struct Option: Codable {
    ...
    public let hasMiniOptions: Bool?
    public let calls: [Contract]?
    public let puts: [Contract]?
    ...
    public init(expirationDate: Int?, hasMiniOptions: Bool?, calls: [Contract]?, puts: [Contract]?) {
